...
94) { echo -n 94 > $HOME/.GameScript/restore_bash4; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash4; } 2>/dev/null ; talk justumen "Here the command ${learn}cp DOS2/test3 .new${reset} is identical to ${learn}cp DOS2/test3 ./.new${reset}."; restore=$(expr $restore + 1) ;&
