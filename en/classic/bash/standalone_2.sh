...
6) echo -n 6 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "The command ${learn}cd${reset} allows us for example to move in the directory of our choice."; restore=$(expr $restore + 1) ;&
...
58) echo -n 58 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Here it is not in the ${learn}ls${reset} command, though it does exist."; restore=$(expr $restore + 1) ;&
59) echo -n 59 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "But how can you show the hidden folder '.GameScript_bash2'?"; restore=$(expr $restore + 1) ;&
60) echo -n 60 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Most commands may have special arguments, which give more details to this command."; restore=$(expr $restore + 1) ;&
...
62) echo -n 62 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk_not_press_key justumen "In order for ${learn}ls${reset} to also display${reset} ${voc}hidden elements, you will have to do ${learn}ls -a${reset}, go ahead."; restore=$(expr $restore + 1) ;&
...
67) echo -n 67 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Now how to get back to this folder ${code}.GameScript_bash2${reset}?"; restore=$(expr $restore + 1) ;&
...
71) echo -n 71 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "I hope the difference between these two ${code}.${reset} in this command is obvious to you."; restore=$(expr $restore + 1) ;&
...
78) echo -n 78 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Since we are talking about repertoire with special symbols, we can also talk about the ${code}~${reset}."; restore=$(expr $restore + 1) ;&
...
89) echo -n 89 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "But you can also, using ${code}~${reset}, use a new absolute path: ${code}~/.GameScript_bash2${reset}"; restore=$(expr $restore + 1) ;&
...
105) echo -n 105 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "But how to retain all options of all orders?"; restore=$(expr $restore + 1) ;&
...
108) echo -n 108 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "To exit the manual, press the 'q' key on your keyboard, such as ${voc}q${reset} uitter."; restore=$(expr $restore + 1) ;&
109) echo -n 109 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk_not_press_key justumen "Open the manual of the ls command with ${learn}man ls${reset}, quickly fly over its contents, and finally leave with the key 'q'."; restore=$(expr $restore + 1) ;&
...
111) echo -n 111 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "If you have forgotten some options of a command, you can still open its manual."; restore=$(expr $restore + 1) ;&
112) echo -n 112 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "If you ask a question on the internet about a command, but the answer is in the manual, it is possible that you have the answer: RTFM."; restore=$(expr $restore + 1) ;&
113) echo -n 113 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "It is an acronym for 'Read The Fucking Manual' or 'Read the Fuck of Manuel'."; restore=$(expr $restore + 1) ;&
114) echo -n 114 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Learning to read manuals is essential to be able to cope with simple problems."; restore=$(expr $restore + 1) ;&
115) echo -n 115 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "With repetition you should remember the most important options, but always have the reflex to visit the manual before asking for help. The manual will always be there for you."; restore=$(expr $restore + 1) ;&
...
142) echo -n 142 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "You are ready for the questionnaire! Go check your knowledge!"; restore=$(expr $restore + 1) ;&
