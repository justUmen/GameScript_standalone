...
6) echo -n 6 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "In this chapter we return to the command ${code}ls${reset}, one of the most important commands."; restore=$(expr $restore + 1) ;&
...
10) echo -n 10 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "With this option, ${code}ls${reset} gives us more information about the elements of the current directory."; restore=$(expr $restore + 1) ;&
11) echo -n 11 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "At the beginning you have a strings string consisting of ${code}-${reset} and letters to the left of the first space of each line."; restore=$(expr $restore + 1) ;&
...
16) echo -n 16 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "It is possible to have multiple users on the same computer."; restore=$(expr $restore + 1) ;&
...
20) echo -n 20 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "These nine characters are used to precisely define the permissions you want."; restore=$(expr $restore + 1) ;&
...
23) echo -n 23 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Conversely, when you see a letter, it means that some type of permission is ${voc}activated${reset}."; restore=$(expr $restore + 1) ;&
...
25) echo -n 25 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "That is to say that they will have to simplify only two possible states."; restore=$(expr $restore + 1) ;&
...
27) echo -n 27 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This ${code}r${reset} comes from the English ${code}r${reset} ead and gives the right to read."; restore=$(expr $restore + 1) ;&
...
29) echo -n 29 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This ${code}w${reset} comes from the English ${code}W${reset} rite and gives the right to write: the modification or deletion."; restore=$(expr $restore + 1) ;&
...
31) echo -n 31 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This ${code}x${reset} comes from the English e ${code}X${reset} ecute and gives the execute right."; restore=$(expr $restore + 1) ;&
32) echo -n 32 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "And this three-character pattern ${code}rwx${reset} is repeated three times."; restore=$(expr $restore + 1) ;&
...
34) echo -n 34 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Example: - ${codeFile} rw -${reset} r ----- 2 ${codeFile} albert${reset} familyEinstein 4096 Feb 19 00:51 Example"; restore=$(expr $restore + 1) ;&
...
36) echo -n 36 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "The three characters in green are albert's permissions."; restore=$(expr $restore + 1) ;&
37) echo -n 37 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Example: -rw - ${codeFile} r -${reset} --- 2 albert ${codeFile} Einstein family${reset} 4096 Feb 19 00:51 Example"; restore=$(expr $restore + 1) ;&
38) echo -n 38 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here the three characters in green are the permissions of the members of the ${voc}group${reset} 'Einstein family'."; restore=$(expr $restore + 1) ;&
39) echo -n 39 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here one can imagine the existence of a group 'Einstein family' for the Einstein family."; restore=$(expr $restore + 1) ;&
40) echo -n 40 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Example: -rw-r - ${codeFile} ---${reset} 2 albert familyEinstein 4096 Feb 19 00:51 Example"; restore=$(expr $restore + 1) ;&
41) echo -n 41 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "And finally, the last three characters are the permissions of other users."; restore=$(expr $restore + 1) ;&
42) echo -n 42 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Those who are neither albert nor in the group "Einstein family"."; restore=$(expr $restore + 1) ;&
43) echo -n 43 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "In this example, albert, the owner of the file has the right to read with this ${code}r${reset} and the write right with this ${code}w${reset}, but not the right to execution because the third character is not a ${codeError} x${reset} but a ${code}-${reset}."; restore=$(expr $restore + 1) ;&
44) echo -n 44 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Members of the'Einstein family 'group are only allowed to read on this file with this ${code}r${reset}."; restore=$(expr $restore + 1) ;&
45) echo -n 45 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "They do not have the right to modify or delete it because there is no ${code}w${reset}!"; restore=$(expr $restore + 1) ;&
46) echo -n 46 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "The rest of the users have no permission because there is no letter for them: ${codeFile} ---${reset}."; restore=$(expr $restore + 1) ;&
47) echo -n 47 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Now back to our files and restart the ${learn}command ls -l${reset}"; restore=$(expr $restore + 1) ;&
...
49) echo -n 49 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "On a simple system, it's likely that you have a group name similar to your username, but that's not a problem."; restore=$(expr $restore + 1) ;&
50) echo -n 50 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "There are therefore many possible permission combinations, here we have 'f1' with the minimum permissions: ${code}---------${reset}."; restore=$(expr $restore + 1) ;&
...
53) echo -n 53 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Start by displaying the contents of the file 'f1'."; restore=$(expr $restore + 1) ;&
...
55) echo -n 55 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "And yes, it is not possible to display the contents of this file because you do not have the right to read."; restore=$(expr $restore + 1) ;&
...
59) echo -n 59 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here no problem with the display."; restore=$(expr $restore + 1) ;&
60) echo -n 60 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Add the text 'cd' at the end of the file 'f2'."; restore=$(expr $restore + 1) ;&
...
62) echo -n 62 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "On 'f2' we still have a permission problem."; restore=$(expr $restore + 1) ;&
...
64) echo -n 64 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "But 'f3' seems to have both ${code}r${reset} and ${code}w${reset}."; restore=$(expr $restore + 1) ;&
...
67) echo -n 67 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "View the content of 'f3'."; restore=$(expr $restore + 1) ;&
...
71) echo -n 71 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Display the contents of 'f3' again."; restore=$(expr $restore + 1) ;&
...
73) echo -n 73 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Perfect ! We can finally use the commands we have learned."; restore=$(expr $restore + 1) ;&
74) echo -n 74 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "But we have never had this permission problem in previous chapters ..."; restore=$(expr $restore + 1) ;&
75) echo -n 75 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "I come here to actually simulate them for you ..."; restore=$(expr $restore + 1) ;&
...
77) echo -n 77 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "But you can also use the ${code}touch${reset} command, so: ${learn}touch file${reset}"; restore=$(expr $restore + 1) ;&
...
79) echo -n 79 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Now we can see the default permissions when creating a new file."; restore=$(expr $restore + 1) ;&
...
83) echo -n 83 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Be careful though, if this file does not come from you, it may have limited or unexpected permissions."; restore=$(expr $restore + 1) ;&
84) echo -n 84 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "We can see here the name of the owner of the file, but is it you?"; restore=$(expr $restore + 1) ;&
...
87) echo -n 87 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "'Who am I?' is English for 'Who am I?'"; restore=$(expr $restore + 1) ;&
88) echo -n 88 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here your name actually corresponds to the name of the owner of this file."; restore=$(expr $restore + 1) ;&
89) echo -n 89 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "But there is at least one other user on your machine!"; restore=$(expr $restore + 1) ;&
90) echo -n 90 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This user has the rights to life and death of everything that exists in your system ..."; restore=$(expr $restore + 1) ;&
91) echo -n 91 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This is your admin account, better known as ${voc}root${reset}."; restore=$(expr $restore + 1) ;&
...
93) echo -n 93 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "And you should be in control of everything that's going on inside."; restore=$(expr $restore + 1) ;&
...
101) echo -n 101 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "You have read rights ${codeFile} r${reset} and execute ${codeFile} x${reset}."; restore=$(expr $restore + 1) ;&
...
103) echo -n 103 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Show the permissions of items in the current directory again."; restore=$(expr $restore + 1) ;&
...
105) echo -n 105 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here we have a folder with the right of reading and writing."; restore=$(expr $restore + 1) ;&
...
108) echo -n 108 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Here, despite having the right to read on this file, we can not move in it."; restore=$(expr $restore + 1) ;&
109) echo -n 109 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "For a text file, the ${codeFile} x${reset} permissions have no effect ..."; restore=$(expr $restore + 1) ;&
110) echo -n 110 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "But here with a ${voc}${reset} folder, the ${codeFile} x${reset} plays an important role!"; restore=$(expr $restore + 1) ;&
...
112) echo -n 112 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "So we can display the elements of this folder, do it so."; restore=$(expr $restore + 1) ;&
113) echo -n 113 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; answer_run "ls File" justumen "No"; restore=$(expr $restore + 1) ;&
114) echo -n 114 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "The contents of 'Folder' is displayed. It contains an 'X' file and a 'Y' file."; restore=$(expr $restore + 1) ;&
115) echo -n 115 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Let's now show the file permissions in this folder."; restore=$(expr $restore + 1) ;&
116) echo -n 116 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; answer_run "ls -l File" justumen "No"; restore=$(expr $restore + 1) ;&
...
118) echo -n 118 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Be careful with these permissions!"; restore=$(expr $restore + 1) ;&
...
120) echo -n 120 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "This is what we will see now: How to change these permissions?"; restore=$(expr $restore + 1) ;&
...
123) echo -n 123 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "The file 'f1' does not give us this permission to display it."; restore=$(expr $restore + 1) ;&
124) echo -n 124 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "To change these permissions it will be necessary to use the command: ${code}chmod${reset}."; restore=$(expr $restore + 1) ;&
125) echo -n 125 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "It will first memorize 3 new letters:"; restore=$(expr $restore + 1) ;&
126) echo -n 126 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "${code}u${reset} for ${code}u${reset} user or owner: - ${codeFile} rwx${reset} rwxrwx"; restore=$(expr $restore + 1) ;&
...
131) echo -n 131 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Restart: ${learn}ls -l${reset}"; restore=$(expr $restore + 1) ;&
...
133) echo -n 133 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "And let's take an example: How can we allow the display of 'f1'?"; restore=$(expr $restore + 1) ;&
...
137) echo -n 137 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "We want the right to read, so it will of course use the letter ${code}r${reset}."; restore=$(expr $restore + 1) ;&
...
139) echo -n 139 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "The syntax will be: ${learn}chmod u + r f1${reset}"; restore=$(expr $restore + 1) ;&
...
142) echo -n 142 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Let's add the read permission to 'f1' for the owner with: ${learn}chmod u + r f1${reset}"; restore=$(expr $restore + 1) ;&
...
144) echo -n 144 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk_not_press_key justumen "Restart: ${learn}ls -l${reset}"; restore=$(expr $restore + 1) ;&
...
154) echo -n 154 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Before going on to the questionnaire I remind you that the right of writing gives the right of ${voc}suppression${reset}."; restore=$(expr $restore + 1) ;&
155) echo -n 155 > $HOME/.GameScript/restore_bash5; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash5; talk justumen "Good luck !"; restore=$(expr $restore + 1) ;&
