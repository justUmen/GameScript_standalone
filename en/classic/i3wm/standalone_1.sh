...
134) echo -n 134 > $HOME/.GameScript/restore_i3wm1; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm1; talk_not_press_key justumen "Workspace 3 has the same html file opened in a web browser (qutebrowser), visit this workspace and come back to GameScript."; restore=$(expr $restore + 1) ;&
