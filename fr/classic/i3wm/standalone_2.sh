...
restore=$1
case $1 in
1) { echo -n 1 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v lxterminal >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
2) { echo -n 2 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v i3 >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
3) { echo -n 3 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v i3status >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
4) { echo -n 4 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v qutebrowser >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
5) { echo -n 5 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v mousepad  >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
6) { echo -n 6 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v leafpad >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
7) { echo -n 7 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v pcmanfm >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
8) { echo -n 8 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v jq >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
9) { echo -n 9 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v feh >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
10) { echo -n 10 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v wmctrl >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
11) { echo -n 11 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v xdotool >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
12) { echo -n 12 > $HOME/.GameScript/restore_i3wm2; } 2>/dev/null ; { echo -n $(pwd) > $HOME/.GameScript/restore_pwd_i3wm2; } 2>/dev/null ; command -v galculator >/dev/null 2>&1 || { echo "Veuillez installer les dépendances requises. Faites en tant qu'administrateur : apt-get install i3 i3status qutebrowser mousepad leafpad pcmanfm jq feh wmctrl xdotool lxterminal galculator" >&2; exit 3; }; restore=$(expr $restore + 1) ;&
esac
}
