...
27) echo -n 27 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ $X -ge 5 ];then"; restore=$(expr $restore + 1) ;&
28) echo -n 28 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ $X -le 10 ];then"; restore=$(expr $restore + 1) ;&
29) echo -n 29 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo La valeur de X est entre 5 et 10."; restore=$(expr $restore + 1) ;&
30) echo -n 30 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
31) echo -n 31 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
32) echo -n 32 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
33) echo -n 33 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ $X -ge 5 ] && [ $X -le 10 ];then"; restore=$(expr $restore + 1) ;&
34) echo -n 34 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo La valeur de X est entre 5 et 10."; restore=$(expr $restore + 1) ;&
35) echo -n 35 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
...
38) echo -n 38 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
39) echo -n 39 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "$V1=true"; restore=$(expr $restore + 1) ;&
40) echo -n 40 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "$V2=true"; restore=$(expr $restore + 1) ;&
41) echo -n 41 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test true && test true;then"; restore=$(expr $restore + 1) ;&
42) echo -n 42 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "TRUE && TRUE is TRUE""; restore=$(expr $restore + 1) ;&
43) echo -n 43 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
44) echo -n 44 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test true && test false;then"; restore=$(expr $restore + 1) ;&
45) echo -n 45 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "TRUE && FALSE is TRUE""; restore=$(expr $restore + 1) ;&
46) echo -n 46 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
47) echo -n 47 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test false && test false;then"; restore=$(expr $restore + 1) ;&
48) echo -n 48 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "FALSE && FALSE is TRUE""; restore=$(expr $restore + 1) ;&
49) echo -n 49 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
50) echo -n 50 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test true || test true;then"; restore=$(expr $restore + 1) ;&
51) echo -n 51 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "TRUE || TRUE is TRUE""; restore=$(expr $restore + 1) ;&
52) echo -n 52 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
53) echo -n 53 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test true || test false;then"; restore=$(expr $restore + 1) ;&
54) echo -n 54 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "TRUE || FALSE is TRUE""; restore=$(expr $restore + 1) ;&
55) echo -n 55 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
56) echo -n 56 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if test false || test false;then"; restore=$(expr $restore + 1) ;&
57) echo -n 57 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "echo "FALSE || FALSE is TRUE""; restore=$(expr $restore + 1) ;&
58) echo -n 58 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "fi"; restore=$(expr $restore + 1) ;&
59) echo -n 59 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
...
61) echo -n 61 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "elif"; restore=$(expr $restore + 1) ;&
62) echo -n 62 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "X=14;if [ $X -ge 10 ] && [ $X -le 20 ];then echo La valeur de X est entre 10 et 20. ($X); elif [ $X -ge 30 ] && [ $X -le 40 ]; then echo La valeur de X est entre 30 et 40. ($X);fi"; restore=$(expr $restore + 1) ;&
63) echo -n 63 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
64) echo -n 64 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "-eq difference with ="; restore=$(expr $restore + 1) ;&
65) echo -n 65 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ "$(whoami)" != 'root' ]; then"; restore=$(expr $restore + 1) ;&
66) echo -n 66 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
67) echo -n 67 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
68) echo -n 68 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
69) echo -n 69 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; MORE ABOUT TEST -f, more ???; restore=$(expr $restore + 1) ;&
70) echo -n 70 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ -f /var/log/messages ]"; restore=$(expr $restore + 1) ;&
...
73) echo -n 73 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
...
75) echo -n 75 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; BASH SCRIPT ARGUMENTS; restore=$(expr $restore + 1) ;&
76) echo -n 76 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "read OR use argument of script !!! $1 !!!!!!"; restore=$(expr $restore + 1) ;&
77) echo -n 77 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ $# -eq 0 ]; then ;; fi"; restore=$(expr $restore + 1) ;&
78) echo -n 78 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "IF NO ARGUMENTS"; restore=$(expr $restore + 1) ;&
79) echo -n 79 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "if [ -z "$1" ]"; restore=$(expr $restore + 1) ;&
...
81) echo -n 81 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
82) echo -n 82 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; BASH SCRIPT VARIABLES; restore=$(expr $restore + 1) ;&
83) echo -n 83 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "$0 $1 $2 $@ $# $_ $- “$@” $!"; restore=$(expr $restore + 1) ;&
...
86) echo -n 86 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
87) echo -n 87 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "variable in script + variable in shell that launched bash"; restore=$(expr $restore + 1) ;&
88) echo -n 88 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "difference bash et ./ (nouvelle instance de bash)"; restore=$(expr $restore + 1) ;&
89) echo -n 89 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "bash ls"; restore=$(expr $restore + 1) ;&
90) echo -n 90 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "shebang"; restore=$(expr $restore + 1) ;&
...
93) echo -n 93 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
...
96) echo -n 96 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "functions"; restore=$(expr $restore + 1) ;&
...
98) echo -n 98 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "argument of functions"; restore=$(expr $restore + 1) ;&
99) echo -n 99 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
100) echo -n 100 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "POSIX ??? [] [[ ]]"; restore=$(expr $restore + 1) ;&
101) echo -n 101 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
102) echo -n 102 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "while <"; restore=$(expr $restore + 1) ;&
...
104) echo -n 104 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "$((expression)) arithmetic"; restore=$(expr $restore + 1) ;&
...
108) echo -n 108 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "SUBSHELLS"; restore=$(expr $restore + 1) ;&
109) echo -n 109 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "subshells and variables : x=2;echo $x;(echo $x;x=1;echo $x);echo $x"; restore=$(expr $restore + 1) ;&
...
111) echo -n 111 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "Regroup with subshells (notice ; is needed)"; restore=$(expr $restore + 1) ;&
112) echo -n 112 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "exec 6<>/dev/tcp/127.0.0.1/9999 	&& echo "Server available on port 9999" 	|| { echo "Please run the server with : php -S 127.0.0.1:9999 -t /home/umen/SyNc/Projects/GameScript/PopUpLearn" && exec 6>&- && exec 6<&- && exit; }"; restore=$(expr $restore + 1) ;&
...
116) echo -n 116 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "CODE PLANNING BEFORE CODING"; restore=$(expr $restore + 1) ;&
...
120) echo -n 120 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
...
122) echo -n 122 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "type source ---> built-in ----> man bash"; restore=$(expr $restore + 1) ;&
123) echo -n 123 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
...
127) echo -n 127 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen ""; restore=$(expr $restore + 1) ;&
128) echo -n 128 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen " avant mise a la ligne to esacpe n (code peut continuer sur une autre ligne)"; restore=$(expr $restore + 1) ;&
...
133) echo -n 133 > $HOME/.GameScript/restore_bash12 2>/dev/null ; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash12 2>/dev/null ; talk justumen "case esac"; restore=$(expr $restore + 1) ;&
