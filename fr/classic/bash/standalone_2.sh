...
107) echo -n 107 > $HOME/.GameScript/restore_bash2; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash2; talk justumen "Vous pouvez toujours accéder au ${code}manuel${reset} d'une commande avec la commande ${learn}man${reset}."; restore=$(expr $restore + 1) ;&
