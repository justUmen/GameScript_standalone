...
125) echo -n 125 > $HOME/.GameScript/restore_bash8; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash8; talk justumen "${code}grep${reset}, utilisé sans deuxième argument, va utiliser, comme ${code}wc${reset}, l'entrée standard."; restore=$(expr $restore + 1) ;&
