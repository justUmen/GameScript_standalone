...
talk justumen "Exemple : -${codeFile}rw-${reset}r----- 2 ${codeFile}albert${reset} Einstein 4096 Feb 19 00:51 Exemple"
...
talk justumen "Exemple : -rw-${codeFile}r--${reset}--- 2 albert ${codeFile}Einstein${reset} 4096 Feb 19 00:51 Exemple"
talk justumen "Ici les trois caractères en vert sont les permissions des membres du ${voc}groupe${reset} 'Einstein'."
talk justumen "Ici on peut imaginer l'existence d'un groupe pour la famille 'Einstein'."
talk justumen "Exemple : -rw-r--${codeFile}---${reset} 2 albert Einstein 4096 Feb 19 00:51 Exemple"
talk justumen "Et enfin, les trois derniers caractères sont les permissions des autres utilisateurs."
talk justumen "Ceux qui ne sont ni albert, ni dans le groupe "Einstein"."
...
talk justumen "Les trois premiers caractères de permissions ne vous concernent donc pas... : d${codeError}rwx${reset}r-xr-x"
