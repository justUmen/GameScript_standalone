...
112) echo -n 112 > $HOME/.GameScript/restore_bash10; echo -n $(pwd) > $HOME/.GameScript/restore_pwd_bash10; talk_not_press_key justumen "Affichez donc par exemple les 10 dernières lignes de tous les fichiers dans la variable 'var'."; restore=$(expr $restore + 1) ;&
