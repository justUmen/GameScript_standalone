...
talk_not_press_key justumen "Maintenant, essayez de vous déplacer dans le dossier DOS et de créer un dossier NEW."
...
talk justumen "Ici le dossier 'DOS' n'existait pas, pourtant la commande ${learn}mkdir NEW${reset} a été lancée."
...
talk justumen "Si vous voulez que la deuxième commande s'execute uniquement si la première a été un succès, vous pouvez utiliser ${code}&&${reset} à la place du ${code};${reset}."
talk_not_press_key justumen "Commencez par supprimez ce dossier NEW."
answer_run "rmdir NEW" justumen "Non"
talk_not_press_key justumen "Maintenant, pour créer un dossier NEW dans DOS."
answer_run "cd DOS&&mkdir NEW" justumen "Non"
talk_not_press_key justumen "Listez les éléments de votre répertoire courant."
answer_run "ls" justumen "Non"
talk justumen "La commande ${learn}cd DOS${reset} renvoyant une erreur, ${code}&&${reset} bloque le lancement de la prochaine commande."
talk justumen "Cette méthode est particulièrement importante si vous utilisez des commandes ${voc}destructrice${reset}, comme ${code}rm${reset}, ou ${code}echo${reset} avec un ${code}>${reset}."
...
answer_run "lss&&echo test" justumen "Non"
talk justumen "Les deux résultats doivent être maintenant pour vous évidents."
talk justumen "Mais il est aussi possible d'avoir les deux conditions sur une seul ligne."
talk_not_press_key justumen "Essayez cette commande : ${learn}cd DIR&&echo SUCCESS||echo ERROR${reset}"
answer_run "cd DIR&&echo SUCCESS||echo ERROR" justumen "Non"
talk justumen "Si vous savez programmer, cette commande peut être vu comme une condition de programmation if/else."
talk_not_press_key justumen "Ici le dossier 'DIR' n'existe pas, remplacez donc par DIR2 avec cette commande : ${learn}cd DIR2&&ls||pwd${reset}"
answer_run "cd DIR2&&ls||pwd" justumen "Non"
talk justumen "Comme le dossier 'DIR2' existe, la commande ${learn}pwd${reset}, ne sera pas exécuté."
